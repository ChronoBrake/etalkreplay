...
var copyCode = function(elem) {
	...
	try {
		if (document.execCommand("copy")) {
			...
			var a1 = "@echo off setlocal enabledelayedexpansion :start set LOL_PATH=\"\" if exist \"%APPDATA%\LoG_lolinstallpath.txt\" ( set /p LOL_PATH0=< \"%APPDATA%\LoG_lolinstallpath.txt\" call :Trim LOL_PATH !LOL_PATH0! echo Manually set Path found: \"!LOL_PATH!\" IF EXIST \"!LOL_PATH!\" ( goto runSpectate ) ) for /F \"delims=\" %%R in (' tasklist /FI \"ImageName eq LeagueClient.exe\" /FI \"Status eq Running\" /FO CSV /NH ') do ( set \"FLAG1=\" & set \"FLAG2=\" for %%C in (%%R) do ( if defined FLAG1 ( if not defined FLAG2 ( set LOL_PID=%%~C IF NOT \"%LOL_PID%\"==\"\" goto pidFound ) set \"FLAG2=#\" ) set \"FLAG1=#\" ) ) FOR %%G IN (\"HKLM\SOFTWARE\WOW6432Node\Riot Games, Inc\League of Legends\") DO ( for /f \"usebackq skip=2 tokens=1,2*\" %%a in (`%systemroot%\system32\REG.EXE QUERY %%G /v \"Location\"`) do  ( set LOL_PATH=%%c echo \"Path found: !LOL_PATH! goto runSpectate ) ) IF EXIST \"C:\Riot Games\League of Legends\" ( set LOL_PATH=\"C:\Riot Games\League of Legends\" goto runSpectate ) IF EXIST \"D:\Riot Games\League of Legends\" ( set LOL_PATH=\"D:\Riot Games\League of Legends\" goto runSpectate ) IF EXIST \"C:\Program Files\Riot Games\League of Legends\" ( set LOL_PATH=\"C:\Program Files\Riot Games\League of Legends\" goto runSpectate ) IF EXIST \"C:\Program Files (x86)\Riot Games\League of Legends\" ( set LOL_PATH=\"C:\Program Files (x86)\Riot Games\League of Legends\" goto runSpectate ) IF EXIST \"C:\Program Files\League of Legends\" ( set LOL_PATH=\"C:\Program Files\League of Legends\" goto runSpectate ) IF EXIST \"C:\Program Files (x86)\League of Legends\" ( set LOL_PATH=\"C:\Program Files (x86)\League of Legends\" goto runSpectate ) IF EXIST \"D:\Program Files\Riot Games\League of Legends\" ( set LOL_PATH=\"D:\Program Files\Riot Games\League of Legends\" goto runSpectate ) IF EXIST \"D:\Program Files (x86)\Riot Games\League of Legends\" ( set LOL_PATH=\"D:\Program Files (x86)\Riot Games\League of Legends\" goto runSpectate ) IF EXIST \"D:\Program Files\League of Legends\" ( set LOL_PATH=\"D:\Program Files\League of Legends\" goto runSpectate ) IF EXIST \"D:\Program Files (x86)\League of Legends\" ( set LOL_PATH=\"D:\Program Files (x86)\League of Legends\" goto runSpectate ) goto notfound";
